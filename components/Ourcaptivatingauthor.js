        ...
        <Container>
          <Row>
            ...
            <div className={styles.capimages}>
              <Image loading="lazy" src={props.img1} className='img-fluid' alt='Texas Book Publishing' ></Image>
              <Image loading="lazy" src={props.img2} className='img-fluid' alt='Texas Book Publishing' ></Image>
              <Image loading="lazy" src={props.img3} className='img-fluid' alt='Texas Book Publishing' ></Image>
            </div>
          </Row>
        </Container>
